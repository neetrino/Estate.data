...
export const ADMIN_LAYOUT_CLASS = "flex min-h-screen";
export const ADMIN_SIDEBAR_CLASS =
  "sticky top-0 flex h-screen w-[280px] shrink-0 flex-col border-r border-foreground/10 bg-white";
export const ADMIN_MAIN_CLASS = "flex min-w-0 flex-1 flex-col";
export const ADMIN_TOPBAR_CLASS =
  "sticky top-0 z-10 flex h-14 shrink-0 items-center justify-between gap-4 border-b border-foreground/10 bg-white/95 px-6 backdrop-blur";
export const ADMIN_CONTENT_CLASS = "flex-1 p-6";
