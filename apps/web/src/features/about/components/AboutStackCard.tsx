...
import {
  ...
  ABOUT_STACK_CHECK_ICON_CLASS,
  ABOUT_STACK_TITLE_CLASS,
...
function AboutStackCheckIcon() {
  return (
    <svg
      viewBox="0 0 16 16"
      fill="none"
      className={`mt-0.5 size-5 shrink-0 lg:size-4 ${ABOUT_STACK_CHECK_ICON_CLASS}`}
      aria-hidden
    >
      <path
...
export function AboutStackCard() {
  ...
  return (
    <article className={`${ABOUT_STACK_CARD_SHELL_CLASS} ${ABOUT_STACK_CARD_CLASS}`}>
