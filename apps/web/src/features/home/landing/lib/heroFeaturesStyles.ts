...
export const HERO_FEATURES_ITEM_CLASS =
  "relative z-10 flex min-w-0 flex-col items-center gap-2 text-center sm:items-start sm:gap-3 sm:text-left";

export const HERO_FEATURES_ICON_CLASS = "size-14 shrink-0 object-contain sm:size-[3.75rem]";

export const HERO_FEATURES_COPY_CLASS = "min-w-0 flex flex-col items-center sm:items-start";
