...
export const STUDIO_SERVICE_EXAMPLES: Record<string, StudioServiceExample> = {
  ...
  [HOME_SECTION_IDS.floorPlans]: {
    ...
    summary:
      "Every Matterport capture includes a navigable dollhouse and a measured digital floor plan — ready for MLS, listings and print.",
    imageUrl: STUDIO_MEDIA.matterport,
    highlights: ["Digital 2D floor plan", "Dollhouse 3D view", "On-screen measurements", "MLS-ready export"],
    embedUrl: MATTERPORT_EMBED_URL,
  },
