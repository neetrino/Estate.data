...
export const STUDIO_PAGE_COPY = {
  ...
  floorPlans: {
    eyebrow: "Floor Plans / 2D–3D",
    title: "Measured plans from the same capture.",
    body: "Every Matterport capture includes a navigable dollhouse and a measured digital floor plan — ready for MLS, listings and print.",
    included: [
      "Digital 2D floor plan",
      "Dollhouse 3D view",
