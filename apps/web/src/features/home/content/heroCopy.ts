...
export const HOME_HERO_COPY = {
  ...
  headlineLines: [
    {
      segments: [{ text: "Cinematic visuals.", accent: false }],
    },
    {
  ...
  descriptionLines: [
    "Estate Data pairs cinematic real estate media with property intelligence — so brokers, developers, and investors close deals with confidence.",
  ] as const,
