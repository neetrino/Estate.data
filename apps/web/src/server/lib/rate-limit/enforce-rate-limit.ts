import { getClientIp } from "@/server/lib/rate-limit/client-ip";
import {
  getAdminRateLimitConfig,
  getContactRateLimitConfig,
  RATE_LIMIT_KEY_PREFIX,
  type RateLimitResult,
} from "@/server/lib/rate-limit/constants";
import { checkMemoryRateLimit } from "@/server/lib/rate-limit/memory-store";
import {
  checkUpstashRateLimit,
  isUpstashRateLimitConfigured,
} from "@/server/lib/rate-limit/upstash-store";
